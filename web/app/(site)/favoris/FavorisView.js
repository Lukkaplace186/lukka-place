 ...
 * localStorage). Client component for that reason; its metadata — including
 * the shared-selection preview card — lives in the server ./page.js.
 *
 ...
 */
export default function FavorisView() {
  const t = useT();
